...
class ParserConfig:
    ...
    enforce_rule_5_strict: bool = True  # Nominative independent (address)
    enforce_rule_6_strict: bool = True  # Nominative absolute
    enforce_rule_7_strict: bool = True  # Apposition
    enforce_rule_8_strict: bool = True  # Compound subject agreement
    enforce_rule_9_strict: bool = True  # Disjunctive conjunctions
    enforce_rule_10_strict: bool = True  # Collective nouns (unity)
    enforce_rule_11_strict: bool = True  # Nouns of multitude (plurality)
    enforce_rule_12_strict: bool = True  # Possessive governance
    enforce_rule_13_strict: bool = True  # Personal pronoun agreement
    enforce_rule_14_strict: bool = True  # Relative pronoun agreement
    enforce_rule_15_strict: bool = True  # Relative nominative case
    enforce_rule_16_strict: bool = True  # Relative governed by verb
    enforce_rule_17_strict: bool = True  # Interrogative pronoun agreement
    ...
    enforce_rule_21_strict: bool = True  # To be same case before/after
    enforce_rule_22_strict: bool = True  # Neuter verbs same case
    enforce_rule_23_strict: bool = True  # Infinitive governed by word
    enforce_rule_24_strict: bool = True  # Infinitive as nominative/object
    enforce_rule_25_strict: bool = True  # Bare infinitive after verbs
    enforce_rule_26_strict: bool = True  # Participles same government
    enforce_rule_27_strict: bool = True  # Present participle refers to subject
    enforce_rule_28_strict: bool = True  # Perfect participle belongs to noun
    enforce_rule_29_strict: bool = True  # Adverbs qualify words
    enforce_rule_30_strict: bool = True  # Prepositions before case
    enforce_rule_31_strict: bool = True  # Prepositions govern objective
    enforce_rule_32_strict: bool = True  # Nouns governed by understood preposition
    enforce_rule_33_strict: bool = True  # Conjunctions connect same case
    enforce_rule_34_strict: bool = True  # Conjunctions connect like moods/tenses
    enforce_rule_35_strict: bool = True  # Noun/pronoun after than/as/but
